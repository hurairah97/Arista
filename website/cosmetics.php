...
?>  <!--Page Title-->
	...
	<div class="page_title_ctn"> 
		<div class="container">
          <h2>Cosmetics</h2>
              ...
              <li class="active"><span>Cosmetics</span></li>
            </ol>
                ...
                ?>                 
                        ...
                        <?php
                           ...
                           $databasePassword = '';//   db password 
                            ...
                            $sql = "SELECT * FROM products join sub_category on products.sub_id=sub_category.sub_id join category on products.category_id=category.id WHERE name='cosmetics'";
    ...
    <div class="row"> 
            ...
            if(isset($_GET['search'])){
                ...
                $query23="SELECT * FROM products join sub_category on products.sub_id=sub_category.sub_id join category on products.category_id=category.id WHERE name='cosmetics' AND CONCAT(`p_name`) LIKE '%$filtervalues%'"; 
                ...
                <?php }}  else
                {
                 ...
                 if(isset($_GET['start_price']) && isset($_GET['end_price']))
                 {
                     ...
                     $query = "SELECT * FROM products join sub_category on products.sub_id=sub_category.sub_id join category on products.category_id=category.id  WHERE name='cosmetics' AND price BETWEEN $startprice AND $endprice";
                 }
                 else
                 {
                     $query = "SELECT * FROM  products join sub_category on products.sub_id=sub_category.sub_id join category on products.category_id=category.id WHERE name='cosmetics' LIMIT $offset, $no_of_records_per_page"; 
                 }
